...
public class BaseCharacter : MonoBehaviour {
	...
	private void SetupPrimamryAttributes(){
	...
	private void SetupVitalModifiers(){
		// modify things such as health energie and mana	
		GetVital((int)VitalName.Health).AddModifier(new ModifyingAttribute(GetPrimaryAttribute((int)AttributeName.Constitution),.5f));
		GetVital((int)VitalName.Energie).AddModifier(new ModifyingAttribute(GetPrimaryAttribute((int)AttributeName.Constitution),1));
